...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_LINE] == '1') {
		...
		for (i = 0; i < 20; i++) {
			...
			y2 = rand() % win_high;
			/* 线的粗细 1~5，颜色随机 */
			hdc_line(x1, y1, x2, y2, 20, RGB(rand() % 256, rand() % 256, rand() % 256));
			Sleep(1);
		}
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		/*下面的参数可以设选一组*/
		hdc_draw_Mathematical_curve_1752846(500.0,205.0,50,500,500,1,RGB(29,251,246));
		//hdc_draw_Mathematical_curve_1752846(600.0, 310.0, 50, 500, 500, 3, RGB(29, 251, 246));
		//hdc_draw_Mathematical_curve_1752846(400.0, 204.0, 100, 500, 500, 3, RGB(29, 251, 246));
		to_be_continued("数学曲线-本人-完成", STL_X, STL_Y);
